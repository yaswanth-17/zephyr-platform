...
how to get started, submit pull requests, report bugs, and add new features.

---
 
### Need help?
 
Open a [GitHub Discussion](https://github.com/yaswanth-17/zephyr-platform/discussions) or file an issue — happy to help you get your contribution merged.
